...
The F5 DevCentral Community team thanks you for showing up. Bug reports, feature ideas, typo fixes, working code: it all counts, and we're glad you're here.

This is the org-wide default for repositories under the [f5devcentral](https://github.com/f5devcentral) organization. Individual repos can publish their own `CONTRIBUTING.md` with project-specific guidance. When they do, that guideline supersedes the org default.
